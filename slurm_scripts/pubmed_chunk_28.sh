#!/bin/bash
#SBATCH --job-name=pubmed_drugs_28
#SBATCH --output=slurm_outputs/pubmed_chunk_28_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_28_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1351
export SLURM_DRUG_END=1400
export SLURM_CHUNK_ID=28
...
echo "Starting PubMed analysis for chunk 28 (drugs 1351 to 1400)"
