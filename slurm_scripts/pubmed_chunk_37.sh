#!/bin/bash
#SBATCH --job-name=pubmed_drugs_37
#SBATCH --output=slurm_outputs/pubmed_chunk_37_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_37_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1801
export SLURM_DRUG_END=1850
export SLURM_CHUNK_ID=37
...
echo "Starting PubMed analysis for chunk 37 (drugs 1801 to 1850)"
