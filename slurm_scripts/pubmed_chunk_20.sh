#!/bin/bash
#SBATCH --job-name=pubmed_drugs_20
#SBATCH --output=slurm_outputs/pubmed_chunk_20_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_20_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=951
export SLURM_DRUG_END=1000
export SLURM_CHUNK_ID=20
...
echo "Starting PubMed analysis for chunk 20 (drugs 951 to 1000)"
