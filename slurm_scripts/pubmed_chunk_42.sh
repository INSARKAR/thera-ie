#!/bin/bash
#SBATCH --job-name=pubmed_drugs_42
#SBATCH --output=slurm_outputs/pubmed_chunk_42_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_42_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=2051
export SLURM_DRUG_END=2100
export SLURM_CHUNK_ID=42
...
echo "Starting PubMed analysis for chunk 42 (drugs 2051 to 2100)"
