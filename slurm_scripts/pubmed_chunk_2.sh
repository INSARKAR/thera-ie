#!/bin/bash
#SBATCH --job-name=pubmed_drugs_2
#SBATCH --output=slurm_outputs/pubmed_chunk_2_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_2_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=51
export SLURM_DRUG_END=100
export SLURM_CHUNK_ID=2
...
echo "Starting PubMed analysis for chunk 2 (drugs 51 to 100)"
