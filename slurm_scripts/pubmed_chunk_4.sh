#!/bin/bash
#SBATCH --job-name=pubmed_drugs_4
#SBATCH --output=slurm_outputs/pubmed_chunk_4_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_4_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=151
export SLURM_DRUG_END=200
export SLURM_CHUNK_ID=4
...
echo "Starting PubMed analysis for chunk 4 (drugs 151 to 200)"
