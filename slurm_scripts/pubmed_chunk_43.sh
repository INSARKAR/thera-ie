#!/bin/bash
#SBATCH --job-name=pubmed_drugs_43
#SBATCH --output=slurm_outputs/pubmed_chunk_43_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_43_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=2101
export SLURM_DRUG_END=2150
export SLURM_CHUNK_ID=43
...
echo "Starting PubMed analysis for chunk 43 (drugs 2101 to 2150)"
