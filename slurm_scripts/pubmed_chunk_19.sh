#!/bin/bash
#SBATCH --job-name=pubmed_drugs_19
#SBATCH --output=slurm_outputs/pubmed_chunk_19_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_19_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=901
export SLURM_DRUG_END=950
export SLURM_CHUNK_ID=19
...
echo "Starting PubMed analysis for chunk 19 (drugs 901 to 950)"
