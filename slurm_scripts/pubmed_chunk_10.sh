#!/bin/bash
#SBATCH --job-name=pubmed_drugs_10
#SBATCH --output=slurm_outputs/pubmed_chunk_10_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_10_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=451
export SLURM_DRUG_END=500
export SLURM_CHUNK_ID=10
...
echo "Starting PubMed analysis for chunk 10 (drugs 451 to 500)"
