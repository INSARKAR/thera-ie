#!/bin/bash
#SBATCH --job-name=pubmed_drugs_7
#SBATCH --output=slurm_outputs/pubmed_chunk_7_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_7_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=301
export SLURM_DRUG_END=350
export SLURM_CHUNK_ID=7
...
echo "Starting PubMed analysis for chunk 7 (drugs 301 to 350)"
