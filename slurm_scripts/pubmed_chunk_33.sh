#!/bin/bash
#SBATCH --job-name=pubmed_drugs_33
#SBATCH --output=slurm_outputs/pubmed_chunk_33_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_33_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1601
export SLURM_DRUG_END=1650
export SLURM_CHUNK_ID=33
...
echo "Starting PubMed analysis for chunk 33 (drugs 1601 to 1650)"
