#!/bin/bash
#SBATCH --job-name=pubmed_drugs_8
#SBATCH --output=slurm_outputs/pubmed_chunk_8_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_8_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=351
export SLURM_DRUG_END=400
export SLURM_CHUNK_ID=8
...
echo "Starting PubMed analysis for chunk 8 (drugs 351 to 400)"
