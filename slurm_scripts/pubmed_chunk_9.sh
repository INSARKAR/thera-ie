#!/bin/bash
#SBATCH --job-name=pubmed_drugs_9
#SBATCH --output=slurm_outputs/pubmed_chunk_9_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_9_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=401
export SLURM_DRUG_END=450
export SLURM_CHUNK_ID=9
...
echo "Starting PubMed analysis for chunk 9 (drugs 401 to 450)"
