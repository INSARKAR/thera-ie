#!/bin/bash
#SBATCH --job-name=pubmed_drugs_26
#SBATCH --output=slurm_outputs/pubmed_chunk_26_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_26_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1251
export SLURM_DRUG_END=1300
export SLURM_CHUNK_ID=26
...
echo "Starting PubMed analysis for chunk 26 (drugs 1251 to 1300)"
