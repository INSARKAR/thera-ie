#!/bin/bash
#SBATCH --job-name=pubmed_drugs_38
#SBATCH --output=slurm_outputs/pubmed_chunk_38_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_38_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1851
export SLURM_DRUG_END=1900
export SLURM_CHUNK_ID=38
...
echo "Starting PubMed analysis for chunk 38 (drugs 1851 to 1900)"
