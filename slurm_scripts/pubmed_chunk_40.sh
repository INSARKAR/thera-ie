#!/bin/bash
#SBATCH --job-name=pubmed_drugs_40
#SBATCH --output=slurm_outputs/pubmed_chunk_40_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_40_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1951
export SLURM_DRUG_END=2000
export SLURM_CHUNK_ID=40
...
echo "Starting PubMed analysis for chunk 40 (drugs 1951 to 2000)"
