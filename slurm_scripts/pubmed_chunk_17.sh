#!/bin/bash
#SBATCH --job-name=pubmed_drugs_17
#SBATCH --output=slurm_outputs/pubmed_chunk_17_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_17_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=801
export SLURM_DRUG_END=850
export SLURM_CHUNK_ID=17
...
echo "Starting PubMed analysis for chunk 17 (drugs 801 to 850)"
