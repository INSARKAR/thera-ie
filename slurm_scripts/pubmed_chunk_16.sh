#!/bin/bash
#SBATCH --job-name=pubmed_drugs_16
#SBATCH --output=slurm_outputs/pubmed_chunk_16_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_16_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=751
export SLURM_DRUG_END=800
export SLURM_CHUNK_ID=16
...
echo "Starting PubMed analysis for chunk 16 (drugs 751 to 800)"
