#!/bin/bash
#SBATCH --job-name=pubmed_drugs_31
#SBATCH --output=slurm_outputs/pubmed_chunk_31_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_31_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1501
export SLURM_DRUG_END=1550
export SLURM_CHUNK_ID=31
...
echo "Starting PubMed analysis for chunk 31 (drugs 1501 to 1550)"
