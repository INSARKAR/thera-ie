#!/bin/bash
#SBATCH --job-name=pubmed_drugs_36
#SBATCH --output=slurm_outputs/pubmed_chunk_36_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_36_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1751
export SLURM_DRUG_END=1800
export SLURM_CHUNK_ID=36
...
echo "Starting PubMed analysis for chunk 36 (drugs 1751 to 1800)"
