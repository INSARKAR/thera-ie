#!/bin/bash
#SBATCH --job-name=pubmed_drugs_21
#SBATCH --output=slurm_outputs/pubmed_chunk_21_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_21_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1001
export SLURM_DRUG_END=1050
export SLURM_CHUNK_ID=21
...
echo "Starting PubMed analysis for chunk 21 (drugs 1001 to 1050)"
