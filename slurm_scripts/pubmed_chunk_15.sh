#!/bin/bash
#SBATCH --job-name=pubmed_drugs_15
#SBATCH --output=slurm_outputs/pubmed_chunk_15_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_15_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=701
export SLURM_DRUG_END=750
export SLURM_CHUNK_ID=15
...
echo "Starting PubMed analysis for chunk 15 (drugs 701 to 750)"
