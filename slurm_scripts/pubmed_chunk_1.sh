#!/bin/bash
#SBATCH --job-name=pubmed_drugs_1
#SBATCH --output=slurm_outputs/pubmed_chunk_1_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_1_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_END=50
export SLURM_CHUNK_ID=1
...
echo "Starting PubMed analysis for chunk 1 (drugs 1 to 50)"
