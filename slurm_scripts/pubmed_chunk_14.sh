#!/bin/bash
#SBATCH --job-name=pubmed_drugs_14
#SBATCH --output=slurm_outputs/pubmed_chunk_14_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_14_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=651
export SLURM_DRUG_END=700
export SLURM_CHUNK_ID=14
...
echo "Starting PubMed analysis for chunk 14 (drugs 651 to 700)"
