#!/bin/bash
#SBATCH --job-name=pubmed_drugs_45
#SBATCH --output=slurm_outputs/pubmed_chunk_45_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_45_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=2201
export SLURM_DRUG_END=2220
export SLURM_CHUNK_ID=45
...
echo "Starting PubMed analysis for chunk 45 (drugs 2201 to 2220)"
