#!/bin/bash
#SBATCH --job-name=pubmed_drugs_23
#SBATCH --output=slurm_outputs/pubmed_chunk_23_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_23_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1101
export SLURM_DRUG_END=1150
export SLURM_CHUNK_ID=23
...
echo "Starting PubMed analysis for chunk 23 (drugs 1101 to 1150)"
