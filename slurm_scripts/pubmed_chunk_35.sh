#!/bin/bash
#SBATCH --job-name=pubmed_drugs_35
#SBATCH --output=slurm_outputs/pubmed_chunk_35_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_35_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1701
export SLURM_DRUG_END=1750
export SLURM_CHUNK_ID=35
...
echo "Starting PubMed analysis for chunk 35 (drugs 1701 to 1750)"
