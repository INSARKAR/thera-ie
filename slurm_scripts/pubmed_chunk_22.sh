#!/bin/bash
#SBATCH --job-name=pubmed_drugs_22
#SBATCH --output=slurm_outputs/pubmed_chunk_22_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_22_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1051
export SLURM_DRUG_END=1100
export SLURM_CHUNK_ID=22
...
echo "Starting PubMed analysis for chunk 22 (drugs 1051 to 1100)"
