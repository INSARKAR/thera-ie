#!/bin/bash
#SBATCH --job-name=pubmed_drugs_3
#SBATCH --output=slurm_outputs/pubmed_chunk_3_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_3_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=101
export SLURM_DRUG_END=150
export SLURM_CHUNK_ID=3
...
echo "Starting PubMed analysis for chunk 3 (drugs 101 to 150)"
