#!/bin/bash
#SBATCH --job-name=pubmed_drugs_5
#SBATCH --output=slurm_outputs/pubmed_chunk_5_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_5_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=201
export SLURM_DRUG_END=250
export SLURM_CHUNK_ID=5
...
echo "Starting PubMed analysis for chunk 5 (drugs 201 to 250)"
