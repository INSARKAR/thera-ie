#!/bin/bash
#SBATCH --job-name=pubmed_drugs_27
#SBATCH --output=slurm_outputs/pubmed_chunk_27_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_27_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1301
export SLURM_DRUG_END=1350
export SLURM_CHUNK_ID=27
...
echo "Starting PubMed analysis for chunk 27 (drugs 1301 to 1350)"
