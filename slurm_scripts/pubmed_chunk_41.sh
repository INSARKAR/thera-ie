#!/bin/bash
#SBATCH --job-name=pubmed_drugs_41
#SBATCH --output=slurm_outputs/pubmed_chunk_41_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_41_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=2001
export SLURM_DRUG_END=2050
export SLURM_CHUNK_ID=41
...
echo "Starting PubMed analysis for chunk 41 (drugs 2001 to 2050)"
