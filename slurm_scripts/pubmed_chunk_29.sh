#!/bin/bash
#SBATCH --job-name=pubmed_drugs_29
#SBATCH --output=slurm_outputs/pubmed_chunk_29_%j.out
#SBATCH --error=slurm_outputs/pubmed_chunk_29_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=8G
...
export SLURM_DRUG_START=1401
export SLURM_DRUG_END=1450
export SLURM_CHUNK_ID=29
...
echo "Starting PubMed analysis for chunk 29 (drugs 1401 to 1450)"
